...
import { idlFactory } from './de-CouncilX-backend.did.js';
export { idlFactory } from './de-CouncilX-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DE_COUNCILX_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./de-CouncilX-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the de-CouncilX-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./de-CouncilX-backend.did.js")._SERVICE>}
 */
export const de_CouncilX_backend = createActor(canisterId);
