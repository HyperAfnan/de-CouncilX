...
import { idlFactory } from './de-CouncilX-frontend.did.js';
export { idlFactory } from './de-CouncilX-frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DE_COUNCILX_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./de-CouncilX-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the de-CouncilX-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./de-CouncilX-frontend.did.js")._SERVICE>}
 */
export const de_CouncilX_frontend = createActor(canisterId);
